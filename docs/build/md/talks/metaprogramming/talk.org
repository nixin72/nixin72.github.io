...
In Lisp, as we all know, we tend to favour recursion. After all, why not? Tail-recursion just gets
optimized into loops anyways, so it's not like we're loosing much performance. Let's look at what
